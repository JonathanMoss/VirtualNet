...
- Focus on active listening, voice discipline, and paper-based tactical cards/slates during radio operations.
...
1. **Net Control Station (Control / SUNRAY)**
   - The primary station responsible for managing and directing the net.
   - Monitors all traffic on the net.
   - Directs sub-stations, controls who has the floor to transmit, coordinates exercises, and maintains net master records.
...
2. **Sub-stations**
   ...
   - Focus on voice procedure, tactical cards (BATCO, Slates, Vocab), and active listening without software-provided log sheets.
...
- **Instructor Oversight**: Provide instructors with a centralized tool to oversee, inject scenario events, and evaluate student performance during and after exercises.
